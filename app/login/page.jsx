    ...
    <div className="relative isolate bg-orange-100 min-h-screen overflow-hidden px-4 lg:px-6">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[144.5rem] max-w-none -translate-x-1/2 rotate-30 bg-gradient-to-tr from-[#ff80b5] to-[#ffb347] opacity-20 sm:left-[calc(50%-40rem)] sm:w-[288.75rem]"
        />
      </div>
